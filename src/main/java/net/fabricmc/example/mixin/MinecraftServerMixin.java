...
public class MinecraftServerMixin implements MinecraftServerAccessor {
    ...
    public void sendTimeStatus(ServerPlayerEntity serverPlayerEntity) {
        serverPlayerEntity.networkHandler.sendPacket(ExampleMod.createTimeStatusPacket(this.getTimeRate(), this.getTimeStopper()));
    }

    private void sendTimeStatus() {
        this.playerManager.sendToAll(ExampleMod.createTimeStatusPacket(this.getTimeRate(), this.getTimeStopper()));
    }
